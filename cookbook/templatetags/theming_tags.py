...
def get_theming_values(request):
    ...
    themes = {
        UserPreference.STILLROOM: 'themes/stillroom.min.css',
        UserPreference.STILLROOM_DARK: 'themes/stillroom_dark.min.css',
    }
    ...
    tv = {
        ...
        'custom_theme': None,
        'theme': static(themes[UserPreference.STILLROOM]),
