...
router.register(r'food-barcode', api.FoodBarcodeViewSet)
...
urlpatterns = [
    ...
    # legacy v1 recipe URL redirects
    ...
    path('openapi/', SpectacularAPIView.as_view(api_version=STILLROOM_VERSION), name='openapi-schema'),
...
urlpatterns += [
    ...
    path('<path:resource>', views.index, name='stillroom_frontend'),
]
