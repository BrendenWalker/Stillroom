...
SOCIALACCOUNT_ADAPTER = 'cookbook.helper.social_adapter.StillroomSocialAccountAdapter'
...
SPECTACULAR_SETTINGS = {
    'TITLE': 'Stillroom',
    'DESCRIPTION': 'Stillroom API Docs',
...
ACCOUNT_EMAIL_SUBJECT_PREFIX = os.getenv('ACCOUNT_EMAIL_SUBJECT_PREFIX', '[Stillroom] ')  # allauth sender prefix
