...
Automations allow Stillroom to automatically perform certain tasks, especially when importing recipes, that
...
Some ingredients have a pattern of AMOUNT and FOOD, if the food has multiple words (e.g. egg yolk) this can cause Stillroom
