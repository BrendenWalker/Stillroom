...
import {STILLROOM_PLUGINS, StillroomPlugin} from "@/types/Plugins.ts";
...
let routes = [
    ...
    {path: '/mealplan', component: MealPlanPage, name: 'MealPlanPage', meta: {title: 'Calendar'}},
    {path: '/this-week', component: () => import("@/pages/MealPlanV2Page.vue"), name: 'MealPlanV2Page', meta: {title: 'Meal_Planner'}},
    ...
    {path: '/view/recipe/:id', redirect: {name: 'RecipeViewPage'}}, // old Stillroom v1 url pattern
...
STILLROOM_PLUGINS.forEach(plugin => {
