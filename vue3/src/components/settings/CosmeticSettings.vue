<template>
    <v-form>
        ...
        <v-select :label="$t('Theme')" class="mt-4" v-model="useUserPreferenceStore().userSettings.theme" :items="[{title: 'Stillroom', value: 'STILLROOM'}, {title: 'Stillroom Dark', value: 'STILLROOM_DARK'}, ]">
        </v-select>
