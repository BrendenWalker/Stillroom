            ...
            <v-container>
                ...
                <v-window v-model="window">
                    ...
                    <v-window-item value="import">
                        <p class="mt-3">The Recipe importer is one of the most powerful features of Stillroom and allows you to quickly add recipes in multiple different ways.
                        </p>
                        ...
                        <p class="mt-3">If you already have an existing Recipe database in another format there is also a good chance Stillroom will have an
                    ...
                    <v-window-item value="ai">
                        ...
                        <p class="mt-3" v-if="useUserPreferenceStore().serverSettings.hosted">
                            To use AI you must first configure an AI Provider. This can also be done globally for all spaces by the person operating your Stillroom Server.
                        </p>
                        <p class="mt-3" v-if="!useUserPreferenceStore().serverSettings.hosted">
                    ...
                    <v-window-item value="unit">
                        ...
                        <p class="mt-3">Setting a base unit allows you to name your Unit however you want (e.g. grams, g, G, gram) while allowing Stillroom
                    ...
                    <v-window-item value="food">
                        <p class="mt-3">Foods have multiple uses in Stillroom. Their most important task is to be part of recipe ingredients together with an amount and
                            a unit.
                        </p>
                    ...
                    <v-window-item value="properties">
                        ...
                        <p class="mt-3">You first need to create the Property Types that you need (e.g. Carbohydrates, Sugar, Price, Points, ..).
                            Setting the FDC ID for a Property Type allows Stillroom to connect your custom Property Type to a property in the FDC database.
                        ...
                        <p class="mt-3">Food Properties are entered based on a certain amount of food (often 100 g). Unit Conversions allow Stillroom to
                    ...
                    <v-window-item value="recipe_search">
                        ...
                        <p class="mt-3">The global quick search can be opened from any page in Stillroom by pressing the search icon in the top right corner.
                    ...
                    <v-window-item value="translations">
                        ...
                        <p class="mt-3">
                            Stillroom translations live in this repository.
