...
const DEVICE_SETTINGS_KEY = 'STILLROOM_DEVICE_SETTINGS'
const USER_PREFERENCE_KEY = 'STILLROOM_USER_PREFERENCE'
const SERVER_SETTINGS_KEY = 'STILLROOM_SERVER_SETTINGS'
const ACTIVE_SPACE_KEY = 'STILLROOM_ACTIVE_SPACE'
const USER_SPACES_KEY = 'STILLROOM_USER_SPACES'
const SPACES_KEY = 'STILLROOM_SPACES'
...
export const useUserPreferenceStore = defineStore('user_preference_store', () => {
    ...
    function updateTheme() {
        if (userSettings.value.theme == 'STILLROOM_DARK' && !isPrintMode.value) {
            theme.change('dark')
        } else {
            theme.change('light')
        }
