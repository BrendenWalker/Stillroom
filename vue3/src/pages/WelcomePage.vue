        ...
        <v-stepper editable v-model="stepper">
            ...
            <v-stepper-window>
                <v-stepper-window-item value="1">
                    <v-card flat>
                        <v-card-title class="text-h4">{{ $t('WelcometoTandoor') }} <span class="text-stillroom">{{ useUserPreferenceStore().userSettings.user.displayName }}</span>
                        </v-card-title>
                        <v-card-text v-if="space">
                            ...
                            <v-select :label="$t('Theme')" v-model="useUserPreferenceStore().userSettings.theme"
                                      :items="[{title: 'Stillroom', value: 'STILLROOM'}, {title: 'Stillroom Dark', value: 'STILLROOM_DARK'}, ]">
                            </v-select>
